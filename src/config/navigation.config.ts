...
export const dashboardPageMeta: Record<string, { title: string; description: string }> = {
  ...
  '/dashboard/calendar': {
    title: 'Calendar',
    description: 'View events, deadlines, exams, and upcoming course activities.',
  },
  '/dashboard/events': {
    title: 'Events',
    description: 'Create and manage scheduled course, institution, and personal events.',
  },
  '/dashboard/enrollments': {
    title: 'Enrollments',
  ...
  '/dashboard/coupons': {
    title: 'Coupons',
    description: 'Create and manage institution discount codes for selected courses.',
  },
  '/dashboard/payments': {
    title: 'Payments',
