...
//             <div className="w-24 h-24 rounded-full bg-muted border-4 border-border overflow-hidden">
//               {profileImage ? (
...
//               )}
//             </div>
//             <label className="absolute -bottom-1 -right-1 w-8 h-8 bg-primary-light hover:bg-primary text-panel-foreground rounded-full flex items-center justify-center cursor-pointer shadow-lg transition-colors">
...
//                 disabled
//                 className="w-full pl-11 pr-4 py-3 border border-border rounded-lg bg-surface text-muted-foreground"
//               />
//             </div>
...
//           {/* Phone */}
//           <div>
//             <label className="block text-sm font-medium text-foreground-muted mb-2">Phone Number</label>
//             <div className="relative">
//               <Phone className="w-5 h-5 text-muted-foreground absolute left-3 top-3.5" />
//               <input
//                 type="tel"
//                 value={studentData?.phone || ""}
//                 onChange={(e) => handleChange("phone", e.target.value)}
//                 className="w-full pl-11 pr-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-colors"
...
//           {/* Gender */}
//           <div>
//             <label className="block text-sm font-medium text-foreground-muted mb-2">Gender</label>
//             <select
...
//           {/* Date of Birth */}
//           <div>
//             <label className="block text-sm font-medium text-foreground-muted mb-2">Date of Birth</label>
//             <div className="relative">
//               <Calendar className="w-5 h-5 text-muted-foreground absolute left-3 top-3.5" />
//               <input
//                 type="date"
...
//                 rows={4}
//                 className="w-full pl-11 pr-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-colors resize-none"
...
//         {/* Action Buttons */}
//         {hasChanges && (
//           <div className="flex flex-col sm:flex-row gap-3 justify-end pt-6 border-t border-border mt-8">
//             <button
//               type="button"
//               onClick={handleReset}
//               disabled={loading}
