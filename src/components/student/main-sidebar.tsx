...
//       }}
//       className="hidden lg:flex fixed left-0 top-0 h-screen flex-col bg-panel border-r border-primary-active overflow-hidden z-50"
//     >
//       {/* Logo */}
//       <div className="flex h-16 items-center border-b border-panel-border px-0 overflow-hidden flex-shrink-0">
//         <Link
//           href="/"
...
//           <span
//             className="text-destructive font-bold text-base flex-shrink-0 flex items-center justify-center"
//             style={{ width: ICON_W, transition: "width 0ms" }}
//           >
//             CDY
//           </span>
//           <span
//             className="text-panel-foreground text-sm font-semibold whitespace-nowrap overflow-hidden"
//             style={{
//               opacity: hovered ? 1 : 0,
...
//               href={href}
//               className={cn(
//                 "flex items-center h-11 text-panel-foreground transition-colors duration-150 relative",
//                 active ? "bg-primary-hover" : "hover:bg-primary-active"
//               )}
//               style={{ width: "100%" }}
//             >
//               {/* Active indicator bar */}
//               {active && (
//                 <span className="absolute left-0 top-0 h-full w-0.5 bg-background rounded-r" />
//               )}
...
//                 {label}
//                 {badge && (
//                   <span className="bg-destructive/100 text-panel-foreground text-xs rounded-full w-5 h-5 flex items-center justify-center flex-shrink-0">
//                     {badge}
//                   </span>
//                 )}
//               </span>
