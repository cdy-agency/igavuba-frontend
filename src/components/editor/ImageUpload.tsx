...
export const ImageUpload = ({ onAddImage, onUploadError }: ImageUploadProps) => {
  ...
  const handleImageUpload = useCallback(
    ...
    [selectedFile, resizePreset, customWidth, customHeight, imageTitle, onAddImage, onUploadError],
  );

  const resetResizeOptions = useCallback((e?: React.MouseEvent) => {
    e?.stopPropagation();
    setSelectedFile(null);
    setImagePreview('');
    setShowResizeOptions(false);
