...
function FilterSection({ title, isOpen, onToggle, children, isLoading }: FilterSectionProps) {
  return (
    <div className="border-t border-border dark:border-border-muted/50 first:border-t-0">
      <button
        type="button"
        onClick={onToggle}
...
export function CourseFilters({
  ...
  return (
    <aside className="md:col-span-1 border border-border dark:border-border-muted/50 dark:border-t-primary border-t-3 shadow-sm dark:shadow-lg dark:shadow-black/20 bg-card border-t-primary overflow-hidden">
      {/* Categories */}
      <FilterSection
        title="Category"
