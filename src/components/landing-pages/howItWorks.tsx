...
export function WorkflowSection() {
  return (
    <section className="py-5 lg:py-10 bg-surface">
            ...
            <div key={step.id} className="relative">
              <div className="relative mb-6 flex justify-center">
                <div className="w-14 h-14 rounded-full bg-primary flex items-center justify-center z-10">
                  <span className="text-panel-foreground font-bold text-lg">
                    {step.id}
                  </span>
                </div>
                ...
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-1/2 left-1/2 w-full px-8 -translate-y-1/2">
                    <div className="border-t-2 border-dotted border-border"></div>
                  </div>
                )}
              </div>
