      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-32">
        <div>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 py-10">
            ...
            {/* Platform Links */}
            <div className="">
              <h3 className="text-sm font-semibold mb-3 text-panel-foreground uppercase">
                Platform
              </h3>
              <ul className="space-y-2">
                {footerLinks.platform.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-sm text-panel-subtle hover:text-panel-foreground transition-colors"
                    >
                      {link.name}
                    </Link>
                  </li>
              ...
              <div className="space-y-3">
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-3">
                    <MapPin className="w-4 h-4 text-panel-muted flex-shrink-0" />
                    <p className="text-panel-subtle">Rwanda, Kigali</p>
                  </div>
                  <div className="flex items-center gap-3">
                    <Phone className="w-4 h-4 text-panel-muted flex-shrink-0" />
                    <a
                      href="tel:+250791896223"
                      className="text-panel-subtle hover:text-panel-foreground transition-colors"
                    >
                      +250 729 119 833
                    </a>
                  </div>
                  <div className="flex items-center gap-3">
                    <Mail className="w-4 h-4 text-panel-muted flex-shrink-0" />
                    <a
                  ...
                  {socialLinks.map((social) => {
                    ...
                    return (
                      <Link
                        key={social.name}
                        href={social.href}
                        className="w-8 h-8 rounded-full bg-panel hover:bg-panel flex items-center justify-center transition-colors"
            ...
            <div className="flex flex-col items-center gap-2 text-center py-4">
              ...
              <p className="text-xs text-panel-muted">
                ...
                <a
                  ...
                  className="hover:text-panel-foreground transition-colors font-medium"
                >
                  CDY Agency
                </a>
              </p>
