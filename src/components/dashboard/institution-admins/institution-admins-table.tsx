...
export function InstitutionAdminsTable() {
  ...
  const { data, isPending, isFetching } = useInstitutionAdminsList({
    page,
    limit: PAGE_SIZE,
  ...
  return (
    <DataTable
      ...
      emptyMessage="No institution admins found."
      ...
      toolbar={
        <DataTableSortSelect
          value={sort}
          options={INSTITUTION_ADMIN_SORT_OPTIONS}
          onValueChange={(value) => {
            setSort(value);
            setPage(1);
          }}
